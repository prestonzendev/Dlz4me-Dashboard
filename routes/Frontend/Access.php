...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
    ...
    Route::group(['middleware' => 'guest'], function () {
        ...
        Route::post('password/create', 'CreatePasswordController@sendCreateLinkEmail')->name('password.create');
        Route::get('password/create/{token}', 'ResetPasswordController@showCreateForm')->name('password.create.form');
