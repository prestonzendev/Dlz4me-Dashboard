            ...
            <tr>
                <td align="left" style="color: #888888; width:20px; font-size: 16px; line-height: 24px;">
                    ...
                    <p style="line-height: 24px; margin-bottom:20px;">
                        Your account is ready to use. Please click on the button below to create your credentials.
                    </p>
                        ...
                        <tr>
                            <td align="center" style="color: #ffffff; font-size: 14px; line-height: 22px;letter-spacing: 1px;font-weight: bold;">
                                ...
                                <div style="line-height: 22px;">
                                    <a href="{{ $reset_password_url }}" style="color: #ffffff; text-decoration: none;">Create Password</a>
                                </div>
                            </td>
                        </tr>
                    ...
                    <p class="small" style="line-height: 24px; margin-bottom:20px;">
                        If you’re having trouble clicking the "Create Password" button, copy and paste the URL below into your web browser:
                    </p>
