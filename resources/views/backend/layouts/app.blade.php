...
<head>
    ...
    <link rel="icon" sizes="16x16" type="image/png" href="http://{!! $_SERVER['SERVER_NAME'] !!}/storage/app/public/img/favicon/{{settings()->favicon}}">
...
<body class="skin-{{ config('backend.theme') }} {{ config('backend.layout') }}">
    ...
    {{ Html::script('js/youcodehere/backend-youcodehere.js') }}
