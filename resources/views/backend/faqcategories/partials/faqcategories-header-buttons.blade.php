<!--Action Button-->
@if( Active::checkUriPattern( 'admin/faqcategories' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.faqcategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.faqcategories.all' ) }}
            </a>
        </li>
        @permission( 'create-faqcategory' )
            <li>
                <a href="{{ route( 'admin.faqcategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.faqcategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
