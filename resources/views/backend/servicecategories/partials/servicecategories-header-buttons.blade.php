<!--Action Button-->
@if( Active::checkUriPattern( 'admin/servicecategories' ) )
    <!-- <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.servicecategories.index' ) }}">
                <i class="fa fa-list-ul"></i> All offer Categories
            </a>
        </li>
        @permission( 'create-servicecategory' )
            <li>
                <a href="{{ route( 'admin.servicecategories.create' ) }}">
                    <i class="fa fa-plus"></i> Create offer Category
                </a>
            </li>
        @endauth
    </ul>
