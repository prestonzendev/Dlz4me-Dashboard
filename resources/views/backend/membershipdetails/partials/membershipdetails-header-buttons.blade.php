<!--Action Button-->
@if( Active::checkUriPattern( 'admin/membershipdetails' ) )
    <!-- <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.membershipdetails.index' ) }}">
                <i class="fa fa-list-ul"></i> List All Details
            </a>
        </li>
        @permission( 'create-membershipdetail' )
            <li>
                <a href="{{ route( 'admin.membershipdetails.create' ) }}">
                    <i class="fa fa-plus"></i> Create Membership Detail
                </a>
            </li>
        @endauth
    </ul>
