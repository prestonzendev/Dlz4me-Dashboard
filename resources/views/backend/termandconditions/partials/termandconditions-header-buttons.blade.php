<!--Action Button-->
@if( Active::checkUriPattern( 'admin/termandconditions' ) )
    <!-- <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.termandconditions.index' ) }}">
                <i class="fa fa-list-ul"></i> All Terms & Conditions
            </a>
        </li>
        @permission( 'create-termandcondition' )
            <li>
                <a href="{{ route( 'admin.termandconditions.create' ) }}">
                    <i class="fa fa-plus"></i> Create New Terms & Conditions Content
                </a>
            </li>
        @endauth
    </ul>
