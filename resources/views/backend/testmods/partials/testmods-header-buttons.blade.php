<!--Action Button-->
@if( Active::checkUriPattern( 'admin/testmods' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.testmods.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.testmods.all' ) }}
            </a>
        </li>
        @permission( 'create-testmod' )
            <li>
                <a href="{{ route( 'admin.testmods.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.testmods.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
