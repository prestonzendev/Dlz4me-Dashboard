...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a href="{{route('admin.access.user.customers.index')}}"><i class="fa fa-list-ul"></i> List</a></li>
        @permission('create-user')
        <li><a href="{{route('admin.access.user.customers.create')}}"><i class="fa fa-plus"></i> Add new</a></li>
        @endauth
