    ...
    <div class="box box-info">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                @include('backend.access.includes.partials.vendor-header-buttons')
                ...
                <table id="users-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('labels.backend.access.users.table.city') }}</th>
                            <th>{{ trans('labels.backend.access.users.table.state') }}</th>
                            <th>{{ trans('labels.backend.access.users.table.country') }}</th>
        ...
        (function() {
            ...
            var dataTable = $('#users-table').dataTable({
                ...
                columns: [
                    ...
                    {data: 'pin_code', name: '{{config('access.users_table')}}.pin_code'},
                    {data: 'email', name: '{{config('access.users_table')}}.email'},
                    {data: 'phone', name: '{{config('access.users_table')}}.phone'},
                    {data: 'city', name: '{{config('access.users_table')}}.city'},
                    {data: 'state', name: '{{config('access.users_table')}}.state'},
                    {data: 'country', name: '{{config('access.users_table')}}.country'},
