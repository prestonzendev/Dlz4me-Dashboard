...
@section('content')
{{ Form::open(['route' => 'admin.access.user.vendor.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post']) }}
...
<div class="box box-info">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                {{ Form::text('country', null, ['id' =>'country','class' => 'form-control box-size', 'placeholder getlatlong' => 'Enter Country']) }}
            </div><!--col-lg-10-->
        </div><!--form control-->
            ...
            <div class="col-lg-8">
                ...
                <div>
                    <label for="role-{{$role->id}}" class="control control--radio">
                        <input type="radio" value="{{$role->id}}" id="role-{{$role->id}}" class="get-role-for-permissions" {{ $role->id == 2 ? 'checked' : '' }} />  &nbsp;&nbsp;{!! $role->name !!}
                        <div class="control__indicator"></div>
