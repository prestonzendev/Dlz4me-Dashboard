...
@section('content')
{{ Form::open(['route' => 'admin.access.user.customers.store', 'class' => 'form-horizontal', 'role' => 'form',  'files' => true, 'method' => 'post']) }}
...
<div class="box box-info">
    ...
    <div class="box-body">
        ...
        {{ Form::hidden('password', 'Dost@123') }}

        {{ Form::hidden('password_confirmation', 'Dost@123') }}
...
<!--        <div class="form-group">
            ...
            <div class="col-lg-10" id="locationField">
                {{ Form::text('address_2', null, ['id' =>'street_number', 'class' => 'form-control box-size', 'placeholder' => 'Enter Street', 'required' => 'required' ,  'disabled'=>'true']) }}
            </div>col-lg-10
        </div>form control-->
        ...
        <div class="form-group">
            {{ Form::label('zip', 'Postal code', ['class' => 'col-lg-2 control-label']) }}

            <div class="col-lg-10">
                {{ Form::text('zip', null, ['id' =>'postal_code','class' => 'form-control box-size getlatlong', 'data-mask' => 'alphazip', 'placeholder' => 'Enter Postal code']) }}
        ...
        <!--div class="form-group">
        {{ Form::label('profilepic', 'Profile Photo', ['class' => 'col-lg-2 control-label']) }}
            ...
            <div class="col-lg-8">
                ...
                <div>
                    <label for="role-{{$role->id}}" class="control control--radio">
                        <input type="radio" value="{{$role->id}}" name="assignees_roles[]" id="role-{{$role->id}}" class="get-role-for-permissions" {{ $role_to_be_created->name == 'Customer' ? 'checked' : '' }} />  &nbsp;&nbsp;{!! $role->name !!}
                        <div class="control__indicator"></div>
