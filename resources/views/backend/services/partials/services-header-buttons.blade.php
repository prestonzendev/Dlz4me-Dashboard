<!--Action Button-->
@if( Active::checkUriPattern( 'admin/services' ) )
    <!-- <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.services.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.services.all' ) }}
            </a>
        </li>
        @permission( 'create-service' )
            <li>
                <a href="{{ route( 'admin.services.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.services.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
