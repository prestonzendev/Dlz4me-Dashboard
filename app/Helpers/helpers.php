...
function generatePincodeNumber() {
    ...
    if (pincodeNumberExists($number)) {
        return generatePincodeNumber();
    }
...
function pincodeNumberExists($number) {
    // query the database and return a boolean
    // for instance, it might look like this in Laravel
    return User::where('pin_code', $number)->exists();
}
