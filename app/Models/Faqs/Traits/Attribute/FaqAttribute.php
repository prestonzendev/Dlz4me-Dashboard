...
trait FaqAttribute
{
    ...
    public function getViewButtonAttribute()
    {
        ...
        return '<a href="'. route('admin.faqs.view', $this) .'" class="btn btn-flat btn-default"><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="'.trans('labels.backend.faqs.view').'"></i></a>';      
    }
