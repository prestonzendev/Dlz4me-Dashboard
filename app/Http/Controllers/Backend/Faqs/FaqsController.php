...
use App\Http\Responses\Backend\Faq\CreateResponse;
...
class FaqsController extends Controller
{
    ...
    {   $faqCategories = Faqcategory::getSelectData();
        return new CreateResponse($faqCategories);
    }
    ...
    {
        $faqCategories = Faqcategory::getSelectData();
        return new EditResponse($faq, $faqCategories);
    }
