...
class SmsController extends Controller
{
    ...
    function __construct() {
		$this->smsVerifcation = new \App\Models\SmsVerification\SmsVerification();
	}
	...
	public function sendSms($request) {
		...
		try {
			...
			'From' => '+18134135434' //we get this number from twilio
			]]);
			return $result;
		}
		catch (Exception $e) {
 	...
 	public function verifyContact(Request $request) {
		$smsVerifcation = 
		$this->smsVerifcation::where('contact_number','=',$request->contact_number)
