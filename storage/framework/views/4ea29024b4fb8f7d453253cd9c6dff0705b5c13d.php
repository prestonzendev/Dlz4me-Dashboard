<!--Action Button-->
    <?php if(Active::checkUriPattern('admin/access/user') || Active::checkUriPattern('admin/access/user/deleted') || Active::checkUriPattern('admin/access/user/deactivated')): ?>
        <!-- <div class="btn-group">
...
<!-- <div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="<?php echo e(route('admin.access.user.index')); ?>"><i class="fa fa-list-ul"></i> List</a></li>
    <?php if (access()->allow('create-user')): ?>
    <li><a href="<?php echo e(route('admin.access.user.create')); ?>"><i class="fa fa-plus"></i> Add new</a></li>
    <?php endif; ?>
    ...
    <li><a href="<?php echo e(route('admin.access.user.deleted')); ?>"><i class="fa fa-trash"></i> Deleted Users</a></li>
    <?php endif; ?>
  </ul>
</div> -->
