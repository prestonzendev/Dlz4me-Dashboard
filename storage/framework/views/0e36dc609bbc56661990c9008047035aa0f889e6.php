<!--Action Button-->
<?php if( Active::checkUriPattern( 'admin/services' ) ): ?>
    <!-- <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="<?php echo e(route( 'admin.services.index' )); ?>">
                <i class="fa fa-list-ul"></i> <?php echo e(trans( 'menus.backend.services.all' )); ?>

            </a>
        </li>
        <?php if (access()->allow('create-service')): ?>
            <li>
                <a href="<?php echo e(route( 'admin.services.create' )); ?>">
                    <i class="fa fa-plus"></i> <?php echo e(trans( 'menus.backend.services.create' )); ?>
